...
DataArray(WeldInfo, AmyWeldInfo, 0x03C546D0, 18);
DataArray(WeldInfo, BigWeldInfo, 0x03C55500, 17);
...
void __cdecl InitAmyWeldInfo_c()
{
	NJS_OBJECT *v0; // edi@1
	NJS_OBJECT *v1; // edi@1
	NJS_OBJECT *v2; // edi@1
	...
	v2 = AMY_OBJECTS[17];
	AmyWeldInfo[7].VertIndexes = vi_004AF5BC;
	AmyWeldInfo[7].ModelB = v2;
	AmyWeldInfo[7].VertexPairCount = (uint8_t)(LengthOfArray(vi_004AF5BC) / 2);
	...
	AmyWeldInfo[8].VertexPairCount = (uint8_t)(LengthOfArray(vi_004AF5CC) / 2);
	AmyWeldInfo[8].WeldType = 2;
	AmyWeldInfo[8].anonymous_5 = 0;
	AmyWeldInfo[8].VertexBuffer = 0;
	AmyWeldInfo[8].VertIndexes = vi_004AF5CC;
	AmyWeldInfo[9].BaseModel = *AMY_OBJECTS;
	AmyWeldInfo[9].ModelA = AMY_OBJECTS[20];
	v3 = AMY_OBJECTS[21];
	AmyWeldInfo[9].VertIndexes = vi_004AF5CC;
	AmyWeldInfo[9].ModelB = v3;
	AmyWeldInfo[9].VertexPairCount = (uint8_t)(LengthOfArray(vi_004AF5CC) / 2);
...
void __cdecl InitBigWeldInfo_fix()
{
	NJS_OBJECT *v0; // ebp@1
	NJS_OBJECT *v1; // edi@1
	NJS_OBJECT *v2; // edi@1
...
extern "C" __declspec(dllexport) void __cdecl Init(const char *path, const HelperFunctions &helperFunctions)
{
	...
	WriteJump((void*)0x007CCB90, InitAmyWeldInfo_c);
	WriteJump((void*)0x007CE860, InitBigWeldInfo_fix);
}
